...
public class ErrorResponseOrNotFoundTest {
    ...
    @Mock
    private GetClientRedirectURI mockGetClientRedirectURIImpl;
    ...
    public void setUp() {
        ...
        ReflectionTestUtils.setField(subject, "getClientRedirectURI", mockGetClientRedirectURIImpl);
    }
    ...
    public void run() throws URISyntaxException, RecordNotFoundException, NotFoundException {
        ...
        when(mockGetClientRedirectURIImpl.run(clientId)).thenReturn(redirectURI);
